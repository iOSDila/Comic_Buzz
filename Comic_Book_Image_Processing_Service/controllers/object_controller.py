...
api = Namespace('object', description='Object related operations')
...
class Object(Resource):
    def post(self):
        ...
        cmd = "cd COD/models/research/object_detection & python Object_detection_image.py " + fileName + " " + job_id
        print(cmd)
        print("COD  started ..")
        ...
        for p in processes:
            ...
            if p.wait() != 0:
                print('Error occurred while detecting objects')
